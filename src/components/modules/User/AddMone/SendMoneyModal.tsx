...
export function SendMoneyModal() {
   ...
   const onSubmit = async (data: z.infer<typeof sendSchema>) => {
        ...
        try {
            ...
            await SendMoney(Info).unwrap(); 
            toast.success("SendMoney Money successfully");
            setOpen(false)
        
        } catch (err) {
            console.error("Error:", err);
            toast.error("SendMoney Money failed");
        }
    };
    return (
            ...
            <form>
                ...
                <DialogContent className="sm:max-w-[425px]">
                    ...
                    <DialogFooter>
                        ...
                        <Button form="SendMoney" type="submit">Send Money</Button>
                    </DialogFooter>
                </DialogContent>
            </form>
        </Dialog>
